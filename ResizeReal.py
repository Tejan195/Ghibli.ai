...
INPUT_FOLDER = os.path.join(BASE_DIR, "dataset", "normal_photos")
OUTPUT_FOLDER = os.path.join(BASE_DIR, "dataset", "processed_normal")
...
print("Resizing completed! All real-world images are now 256x256 in RGB format.")